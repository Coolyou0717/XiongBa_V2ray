...
uuid="92a29b4e-c4e2-43b3-888f-c3602ebb80aa"
...
install_v2ray() {
	...
	if [[ $local_install ]]; then
		...
		#git clone https://github.com/Coolyou0717/XiongBa_V2ray -b "$_gitbranch" /etc/v2ray/233boy/v2ray --depth=1
...
fix_download_v2ray_file() {
	...
	v2ray_download_link="https://github.com/v2fly/v2ray-core/releases/download/v4.45.2/v2ray-linux-${v2ray_bit}.zip"
